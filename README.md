...
> Upload any product image → Gemini writes a compelling description instantly.

![Python](https://img.shields.io/badge/Python-3.10+-3776AB?logo=python&logoColor=white)
![Streamlit](https://img.shields.io/badge/Streamlit-1.35-FF4B4B?logo=streamlit&logoColor=white)
![Gemini](https://img.shields.io/badge/Gemini-gemini--3.6--flash-4285F4)
...
| Feature | Detail |
|---|---|
| 🖼️ **Vision-Powered** | Gemini reads and understands the actual product image |
